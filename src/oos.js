export default [
  {
    ...
    friends: ['yooga'],
    friendships:
      'Disc’Oo s’entend très bien avec Y’Oo’ga ! Il lui propose toujours des playlists calmes et relaxantes pour ses exercices de méditation. Il aime aussi jouer avec Wh’Oo’w, qui lui propose toujours de découvrir de nouveaux artistes grâce au hasard.',
  },
  {
    name: "Wh'Oo'w",
    color: '#FF9000',
  ...
  },
  {
    ...
    friends: ['yooga', 'gatoo'],
    friendships:
      'Végét’Oo aime parler relaxation avec Y’Oo’ga, il lui arrive souvent de méditer avec ses plantes, et Y’Oo’ga lui donne toujours des conseils pour ça. Il apprécie aussi les recettes de cuisine de Gat’Oo, même s’il préfère quand les plantes poussent, il aime aussi découvrir leur saveur dans un bon petit plat.',
  },
  {
    name: "Cin'Oo'che",
    color: '#D9283E',
    ...
    friends: ['coomique', 'anecdoote'],
    friendships:
      'Cin’Oo’che s’entend super bien avec Anecd’Oo’te, car ils peuvent se partager leur connaissance sur le 7eme art. Il adore aussi rigoler avec C’Oo’mique, car il y a beaucoup de blagues dans les répliques de films.',
  },
  {
    name: "C'Oo'mique",
    color: '#FFC402',
    ...
    traits: {
      ...
      Taquin: 'C’Oo’mique c’est aussi le petit malin de la bande, celui qui va faire des blagues à ses compagnons pour les taquiner.',
    },
